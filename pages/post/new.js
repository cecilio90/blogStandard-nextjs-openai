...
export default function NewPost() {
  ...
  return (
    <div className="h-full overflow-hidden">
      {!!generating && (
        <div className="text-green-600 flex h-full w-full flex-col animate-pulse justify-center items-center">
      ...
      {!generating && (
        <div className="w-full h-full flex flex-col overflow-auto">
          <form className="m-auto w-full max-w-screen-sm bg-slate-100 p-4 rounded-md shadow-xl border-slate-200 shadow-slate-200" onSubmit={handleSubmit}>
            <div>
              <label>
                <strong>
