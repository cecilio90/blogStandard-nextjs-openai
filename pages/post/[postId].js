      ...
      <div className="max-w-screen-sm mx-auto">
        ...
        <div className="flex flex-wrap pt-2 gap-1">
          {props.keywords.split(",").map((keyword, i) => (
            <div key={1} className="p-2 rounded-full bg-slate-800 text-white">
        ...
        <div className="my-4">
          {!showDeletionConfirm && (
            <button onClick={()=> setShowDeletionConfirm(true)} className="btn bg-red-600 hover:bg-red-700">
              Delete post
            </button>
          )}
          {showDeletionConfirm && (
            <div>
              ...
              <div className="grid grid-cols-2 gap-2">
                <button onClick={() => setShowDeletionConfirm(false)} className="btn bg-stone-600 hover:bg-stone-700">
                  cancel
                </button>
